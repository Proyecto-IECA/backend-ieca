const messageRegistro = (url) => {
    const messageR = {
        ...
        <div style="padding: 30px 0; font-size: 24px; text-align: center; line-height: 40px;">Gracias por registrarte! Haga clic en el siguiente botón 
...
const messageRenewPass = (url) => {
    const messageRP = {
        ...
        <div style="padding: 0 30px 30px 30px; border-bottom: 3px solid #eeeeee;">
        <div style="padding: 30px 0; font-size: 24px; text-align: center; line-height: 40px;">Para actualizar tu contraseña!Haga clic en el siguiente botón</div>
